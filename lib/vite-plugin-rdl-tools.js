...
import { formatRDL } from "./rdl-print.js";

function tokenizeRDL(input) {
...
export default function rdlTools(options = {}) {
  ...
  return {
    ...
    load(id) {
      if (id.endsWith(".ui?format")) {
        ...
        const formatted = formatRDL(code);
