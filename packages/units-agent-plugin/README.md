...
Compiler output is token-optimized by default (implicit role actions and redundant leaf `name` props are omitted unless explicitly requested in compiler options).
