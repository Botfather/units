...
Compiler output is token-optimized by default (implicit role actions and redundant leaf `name`/text duplicates are omitted unless explicitly requested in compiler options).
