...
For token efficiency, compact serialization deduplicates redundant `name`/`text` pairs by default. Set `includeRedundantNameText: true` to preserve both fields when they are identical.
